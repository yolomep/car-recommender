...
class _MyHomePageState extends State<MyHomePage> {
  ...
  //in case if the data is not unique (pretty sure it is)
  ...
  RangeValues _currentPriceRange = const RangeValues(10000, 100000);
  ...
  void initState() {
    ...
    readData().then((options) {
      setState(() {
        ...
        _makeDropdownValue = _makeOptions.first;
                  ...
                  onPressed: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(builder: (context) {
                        return AdvancedScreen(Car.fromData(make: _makeDropdownValue, model: _modelDropdownValue, priceRange: _currentPriceRange));
                      }),
                    );
                  },
                ...
                TextButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) {
                        return ResultsScreen(Car.fromData(make: _makeDropdownValue, model: _modelDropdownValue, priceRange: _currentPriceRange));
                      }),
                    );
                  },
                  style: TextButton.styleFrom(
